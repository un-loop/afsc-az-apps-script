...
export class UserSubmission {
    ...
    incrementRetryCount = () => {
        ...
        this.sheet.getRange(this.rowIndex, this.header.RETRY_COUNT).setValue(this.row.retry_count);
    }
    ...
    sendConfirmationEmail() {
        ...
        this.sheet.getRange(this.rowIndex, this.header.EMAIL_SENT).setValue(emailSentStatus);
    }
